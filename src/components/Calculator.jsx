...
function Calculator() {
    ...
    return (
        <div className="bg-gray-800 text-white w-screen h-screen flex justify-center items-center">
            <div className="w-64 h-auto bg-gray-900 rounded-2xl shadow-xl border-4 border-gray-100">
                ...
                <div className="keyboard">
                    <div className="m-2 flex justify-between">
                        ...
                        <input type="button" onClick={backspace} value="<-" className="bg-gray-200 shadow-md rounded-lg w-12 h-12 text-center text-black font-medium flex justify-center items-center outline-none" />
            ...
            <footer>
                <p class="footer-text">Calculator</p>
                <p>Created with love by Riya <b>&hearts;</b></p>
            </footer>
        </div>
    )
}
